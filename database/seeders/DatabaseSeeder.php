...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $classes = [
            ...
            ['thing_id' => 'db91a470-2590-4f33-92bd-3e3dd33f5353', 'name' => 'Bycicle',                  'description' => 'Велосипед',                                                                                                                          'type' => UUID::G_CLASS, 'public' => true],
            ...
            ['thing_id' => '81aa3a58-1a61-4a83-9046-6f5ec836a347', 'name' => 'Epiphone Riviera',          'description' => '',                                                                                                                                   'type' => UUID::G_CLASS, 'public' => true],
            ...
            ['thing_id' => 'dbd6eec5-9df1-473b-bf65-42e68f4e5d7b', 'name' => 'Guitar processor',         'description' => 'Гитарный процессор',                                                                                                                  'type' => UUID::G_CLASS, 'public' => true],
            ...
            ['thing_id' => '8ac2606d-d008-4588-8b9a-09a79ee5f44a', 'name' => 'Music Performance Set list','description' => '',                                                                                                                                   'type' => UUID::G_CLASS, 'public' => true],
            ['thing_id' => '5a0f67ea-a290-4ef6-9ac5-0e85d967c4f9', 'name' => 'Opel Zafira B',            'description' => '',                                                                                                                                   'type' => UUID::G_CLASS, 'public' => true],
            ...
            ['thing_id' => 'cf74b151-7161-4f80-b4e5-41b2de69c6ca', 'name' => 'ZOOM 707II',              'description' => '',                                                                                                                                   'type' => UUID::G_CLASS, 'public' => true],
            ['thing_id' => 'dbb3866e-e5a8-4186-b6e3-a273a42b1809', 'name' => 'Квартира',                 'description' => 'Квартира, офис',                                                                                                                       'type' => UUID::G_CLASS, 'public' => true],
            ['thing_id' => '1fdf78e0-aa61-4e52-bbed-4ce157da78ab', 'name' => 'Спортивная секция',         'description' => '',                                                                                                                                   'type' => UUID::G_CLASS, 'public' => true],
        ];
