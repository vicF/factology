// resources/js/localDb/seedData.js
//
...
export const CLASS_LINKS = [
    // Event → subclasses
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '36255438-6a10-4036-8df3-7894801b2759', translation: 'This is child of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '770b8c20-fb65-4896-9de6-21cecc03a332', translation: 'Performance is subclass of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '7faa08e2-d882-4aa2-af0c-28c7d381030a', translation: 'This is child of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '89539d56-fea3-4349-a3f2-f4cff229f879', translation: 'This is child of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '960e0074-5945-4163-a9ba-576a09ced6da', translation: 'This is child of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: '97bcbb9c-31f6-4c3c-913c-dfa54bce03e4', translation: 'Illness is a child of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: 'ac598f55-78b4-41c9-aaa6-32fa6a93d939', translation: 'Subclass of Event' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: 'af6d4e0b-f452-442e-9fba-dcb60546b11d', translation: 'Object is of class' },
    { one: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', other: 'e3cad1b0-74fa-44b2-9b2f-2adaf36baa14', translation: 'Trip is subclass of Event' },
    // Disaster → subclasses
    { one: '36255438-6a10-4036-8df3-7894801b2759', other: 'f9d434b8-28d9-45d5-bf19-a625319ea63b', translation: 'This is child of Disaster' },
    // Vehicle → subclasses
    { one: '11544624-be5c-4cdc-8fe1-701c09391464', other: '4e605e49-3bbc-4bae-83fd-f1e7d7c76a77', translation: 'Car is subclass of Vehicle' },
    { one: '11544624-be5c-4cdc-8fe1-701c09391464', other: 'db91a470-2590-4f33-92bd-3e3dd33f5353', translation: 'This is child of Vehicle' },
    // Computer Data → subclasses
    { one: '4e3b5c5f-f347-42d9-9e93-3093b420d2f5', other: '4f76b1b0-9de4-4c60-8e52-53fa429faabe', translation: 'Folder is subclass of Computer Data' },
    { one: '4e3b5c5f-f347-42d9-9e93-3093b420d2f5', other: '5a626fa7-b69f-4042-9556-374f10df0a2c', translation: 'File is subclass of Computer Data' },
    { one: '4e3b5c5f-f347-42d9-9e93-3093b420d2f5', other: 'ad3f8571-9b56-40af-b9c0-8d375f3b1976', translation: 'Computer Media is subclass of Computer Data' },
    // Computer Media → subclasses
    { one: 'ad3f8571-9b56-40af-b9c0-8d375f3b1976', other: '03d72750-32b4-4c52-8a59-37fbb93b3082', translation: 'Audio is subclass of Computer Data' },
    { one: 'ad3f8571-9b56-40af-b9c0-8d375f3b1976', other: '4b22a805-f3e1-47b9-bb87-b7a9f6f68cc4', translation: 'Image is subclass of Computer Media' },
    { one: 'ad3f8571-9b56-40af-b9c0-8d375f3b1976', other: 'da17d697-d877-4625-8bcd-944570a21796', translation: 'Video is subclass of Computer Data' },
    // Something → subclasses
    { one: UUID.SOMETHING, other: '0eed3b56-bdd6-47f0-9413-d9640a9dcafc', translation: 'Event is subclass of Something' },
    { one: UUID.SOMETHING, other: '26570302-457d-4282-a949-9a9917515de3', translation: 'Task is a child of Something' },
    { one: UUID.SOMETHING, other: '4e3b5c5f-f347-42d9-9e93-3093b420d2f5', translation: 'Computer Data is subclass of Something' },
    { one: UUID.SOMETHING, other: '6a65dbf3-ad39-4446-8b8b-c0f539c1d53a', translation: 'Collection is subclass of Something' },
    { one: UUID.SOMETHING, other: '71e49073-503f-4faa-932d-68ab89662420', translation: 'Live Being is subclass of Something' },
    { one: UUID.SOMETHING, other: '9f7436db-6253-4718-aa61-b4676faa90c7', translation: 'This is child of Something' },
    { one: UUID.SOMETHING, other: 'baeb5e5f-2659-4cb0-8260-55af9fadbe13', translation: 'Thing is subclass of Something' },
    { one: UUID.SOMETHING, other: 'dc006cda-047a-4862-acf7-e215355b6890', translation: 'Place is subclass of Something' },
    { one: UUID.SOMETHING, other: 'f48ef10a-40f6-4190-bfae-2834e9781ad1', translation: 'This is child of Something' },
    // Collection → subclasses
    { one: '6a65dbf3-ad39-4446-8b8b-c0f539c1d53a', other: '4ed8a123-eceb-4c30-a8d6-c5694ce3d2f8', translation: 'List is a child of Collection' },
    { one: '6a65dbf3-ad39-4446-8b8b-c0f539c1d53a', other: 'c0e229b8-6e56-45ee-b454-71e557cdb191', translation: 'Group is subclass of Collection' },
    // Group → subclasses
    { one: 'c0e229b8-6e56-45ee-b454-71e557cdb191', other: '1fdf78e0-aa61-4e52-bbed-4ce157da78ab', translation: 'Спортивная секция is a child of Group' },
    { one: 'c0e229b8-6e56-45ee-b454-71e557cdb191', other: '2067c7bf-0f6f-491d-af2b-10105db4e8cc', translation: 'This is child of Group' },
    { one: 'c0e229b8-6e56-45ee-b454-71e557cdb191', other: 'caf05706-c73d-43e9-a496-6069f9aefc99', translation: 'Music band is of class Group' },
    // Live Being → subclasses
    { one: '71e49073-503f-4faa-932d-68ab89662420', other: '4c8ee41a-9912-4dff-8b44-7779a66e4fcf', translation: 'Human is subclass of Live Being' },
    // Character → subclasses
    { one: 'f48ef10a-40f6-4190-bfae-2834e9781ad1', other: '860dd2fe-b70f-42b2-a446-20528245eeff', translation: 'This is child of Character' },
    { one: 'f48ef10a-40f6-4190-bfae-2834e9781ad1', other: 'aea400ce-a2e4-4d56-a3ba-3ab1bdd30e7a', translation: 'This is child of Character' },
    // Thing → subclasses
    { one: 'baeb5e5f-2659-4cb0-8260-55af9fadbe13', other: '69087526-c024-43a8-81bc-c067487e11bb', translation: 'This is child of Thing' },
    { one: 'baeb5e5f-2659-4cb0-8260-55af9fadbe13', other: 'c38cad91-7747-4bbc-abd3-09b50e6e4672', translation: 'This is child of Thing' },
    // Piece of art or work → subclasses
    { one: '69087526-c024-43a8-81bc-c067487e11bb', other: '4fdcbd06-3233-4dcc-8259-fd6150cce007', translation: 'Music is a child of Piece of art or work' },
    { one: '69087526-c024-43a8-81bc-c067487e11bb', other: 'fb8d457c-62b4-43e9-9e4d-014201176f01', translation: 'This is child of Piece of art or work' },
    // Product → subclasses
    { one: 'c38cad91-7747-4bbc-abd3-09b50e6e4672', other: '11544624-be5c-4cdc-8fe1-701c09391464', translation: 'This is child of Product' },
    { one: 'c38cad91-7747-4bbc-abd3-09b50e6e4672', other: '52e2b5ce-562b-46eb-98b7-48703ed62a7e', translation: 'This is child of Product' },
    { one: 'c38cad91-7747-4bbc-abd3-09b50e6e4672', other: '7bdf2d4a-5329-4603-9562-b5c656d45306', translation: 'Vessel is a child of Product' },
    { one: 'c38cad91-7747-4bbc-abd3-09b50e6e4672', other: 'ea7aed7a-8cdf-45e4-9896-43c57ffdf132', translation: 'Computing Device is a child of Product' },
    // Vessel → subclasses
    { one: '7bdf2d4a-5329-4603-9562-b5c656d45306', other: 'd6320bf5-ca8b-4e50-ad5c-873216d9fcf0', translation: 'Yacht is a child of Vessel' },
    // Music equipment → subclasses
    { one: '52e2b5ce-562b-46eb-98b7-48703ed62a7e', other: '934efd3c-9781-4f2a-bd51-716a75cf5874', translation: 'This is child of Music Equipment' },
    // Music Instrument → subclasses
    { one: '934efd3c-9781-4f2a-bd51-716a75cf5874', other: '90d97b01-ee65-4be5-ae27-fb9bec2aeedf', translation: 'This is child of Music Instrument' },
    // Place → subclasses
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '14cd9c8b-84a4-4fd2-82a8-97477ff2d5ee', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '20f6b1ae-86de-4221-bf0c-995be2687405', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '2922e0c4-e82b-45e3-b85a-17619d75c37f', translation: 'Object is of class' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '3c7d2abc-3f31-4c73-bbbd-3e7b2e620630', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '4ec0a490-9a24-491c-b0d7-c994d58fc468', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '5787ef00-3f6b-46fe-9e93-d32c9ebdeab4', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '602f1b6b-1383-442b-908c-1a027d7a8010', translation: 'Restaurant, club, bar is subclass of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '6170d4e4-aab7-443b-baa1-f77dabc0e201', translation: 'Functional place is a child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '73482bbe-d377-4e01-9efb-de135916c94a', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: '8617d9c3-94fb-4f75-a983-1d8ba0822b0d', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: 'a31e2319-d8e0-4e48-98c8-3f23d0a17d50', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: 'ad4be260-0af0-4e7c-928e-a7177158e1d0', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: 'd0eefbac-ce31-4bf1-b392-61e3a6d17ae5', translation: 'This is child of Place' },
    { one: 'dc006cda-047a-4862-acf7-e215355b6890', other: 'f989e699-dc6f-45f8-a985-145d28f68ffd', translation: 'This is child of Place' },
    // Flat → subclasses
    { one: 'dbb3866e-e5a8-4186-b6e3-a273a42b1809', other: '6170d4e4-aab7-443b-baa1-f77dabc0e201', translation: 'Functional place is a child of Квартира' },
    // Water area → subclasses
    { one: 'f989e699-dc6f-45f8-a985-145d28f68ffd', other: '62e7ab56-4ebe-4002-a7f1-896e266b8078', translation: 'This is child of Water area' },
    { one: 'f989e699-dc6f-45f8-a985-145d28f68ffd', other: '7d548ec2-69e9-4329-b122-acb83cd83325', translation: 'This is child of Water area' },
    // System → subclasses
    { one: UUID.SYSTEM, other: UUID.USER,                       translation: 'User is subclass of System' },
    { one: UUID.SYSTEM, other: 'c532f6ba-27b2-43ec-b4ec-30cbff78eed0', translation: 'Access group is subclass of System' },
    ...
    { one: UUID.SYSTEM, other: UUID.G_SERVER_CLASS,              translation: 'Server is subclass of System' },
];
