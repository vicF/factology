        ...
        >
            ...
            <div class="node-content">
                <span class="node-name">
                    ...
                    <span v-if="!nodePublic && authenticated" class="private-icon" title="Private" @click.stop="toggleVisibility(true)"><IconPrivate /></span>
                    <span v-else-if="!nodePublic" class="private-icon" title="Private"><IconPrivate /></span>
                    <span v-if="nodePublic && authenticated" class="public-icon" title="Public" @click.stop="toggleVisibility(false)"><IconPublic /></span>
                    <span v-else-if="nodePublic" class="public-icon" title="Public"><IconPublic /></span>
                </span>
